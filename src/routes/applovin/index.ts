...
router.put(
    ...
    async (req: Request, res: Response) => {
        ...
        try {
            ...
            await conn.query(`UPDATE users SET ticket=ticket+3,ads=?,totalAds=totalAds+1,ads20=ads20+1,waitingTime = waitingTime + ? WHERE uid=?`, [parseInt((Date.now() / 1000).toString()) + r[0].waitingTime, (r[0].ads20 > 50 ? 20 : 0), res.locals.uid]);
